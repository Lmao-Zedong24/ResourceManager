...
Camera::Camera() :
	m_projectionMatrix(Mat4::perspectiveProjection(120_deg, 16.f / 9.f, .01f, 200.f))
{
	m_UnlinkedGlobalMats.push_back(LibMath::Matrix4(1));
	m_globalMat = &m_UnlinkedGlobalMats.back();
