...
//void OpenGl::CollisionManager::Init()
//{
//}

Collider* OpenGl::CollisionManager::AddCollider(	GameObject* p_GO, 
...
void OpenGl::CollisionManager::SortAndSweep()
{
}

void OpenGl::CollisionManager::Update()
{
...
OpenGl::CollisionManager* OpenGl::CollisionManager::GetInstance()
{
